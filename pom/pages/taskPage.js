...
class TaskPage{ //byDefault: TodayPage
    constructor(){
        ...
        this.addTaskPlusButton = Selector('.plus_add_button')
        ...
        this.tomorrowOption = Selector('.scheduler-suggestions-item-label').withExactText('Tomorrow')
    }

    async addNewTaskForToday(task){
        await t
            .click(this.addTaskPlusButton)
